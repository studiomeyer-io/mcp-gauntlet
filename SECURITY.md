...
`mcp-gauntlet` is a **testing tool for servers you are authorized to test.** `mcp-fuzz` sends
...
executed by `mcp-gauntlet` itself**; any effect is entirely up to the server under test.
